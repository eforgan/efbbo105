...
```mermaid
graph LR
    SG[Base: Aeródromo Sierra Grande<br>SA21] -->|Transit Terrestre 30 km| PC[Punta Colorada<br>Línea de Costa]
    PC -->|7 km Overwater < 2.5 min| SEM[DLV Seminole<br>7 km Offshore - Helideck 22.2m]
    SEM -->|Hot Loading & Despegue| PC2[Punta Colorada<br>Entrada a Costa]
    PC2 -->|Transit Costero 115 km| PM[Destino: Aeropuerto Puerto Madryn<br>SAVY / El Tehuelche]

    style SG fill:#34495e,color:#fff
    style PC fill:#7f8c8d,color:#fff
    style SEM fill:#e74c3c,color:#fff
    style PC2 fill:#7f8c8d,color:#fff
...
```mermaid
graph TD
    A[Aproximación al DLV Seminole] --> B{Contacto VHF Marítima Ch 16 / Trab}
    B --> C[Confirmación de Viento Relativo y Rumbo de Fondeo]
    C --> D{¿HLO confirma GREEN DECK?}
    D -- SI --> E[Aterrizaje en Helideck Octogonal 22.2m]
    E --> F[Hot Loading: Embarque de Paciente con Rotores Girando]
    F --> G[Verificación de Puertas y Despegue]
    D -- NO --> H[Mantener Estacionario de Seguridad o Wave-Off]
