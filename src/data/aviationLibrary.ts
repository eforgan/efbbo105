    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'Zona YPF VMOS Offshore (Golfo San Matías): Aplicación obligatoria de este numeral por el tramo de 7 km sobre agua entre Punta Colorada y la Boya 7, punto de retorno de la traza offshore del gasoducto (Gral. Roca - Punta Colorada).',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'APLICACIÓN HEMS OFFSHORE: El tramo Punta Colorada - Boya 7 (traza gasoducto YPF VMOS) es un tránsito de crucero sin punto de aterrizaje — no aplica cálculo HOGE de plataforma, pero debe mantenerse margen de capacidad OEI (techo monomotor) durante toda la exposición sobre agua.',
